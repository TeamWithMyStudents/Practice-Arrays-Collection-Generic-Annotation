...
public class CheckAndPrintTools {
    ...
    public static boolean checkClassForAnnot() {
        return CheckCamelCase.checkAndPrint(home.work.task7.ClassForAnnot.class);
    }

    public static boolean checkClass1() {
        return CheckCamelCase.checkAndPrint(home.work.task7.Class1.class);
    }

    public static boolean checkClass2() {
        return CheckCamelCase.checkAndPrint(home.work.task7.Class2.class);
    }
