...
class Task7Test {
    ...
    public void isPublicInterface() {
        assertTrue(CheckAndPrintTools.isPublicInterface("home.work.task7.CamelCase"));
    }

    @DisplayName("Checks if annotation @Target is used with CamelCase")
    @Test
    public void isTargetMethod() {
        assertTrue(CheckAndPrintTools.isTargetMethod("home.work.task7.CamelCase"));
    }

    @DisplayName("Checks if annotation @Retention is used with CamelCase")
    @Test
    public void isRetentionRuntime() {
        assertTrue(CheckAndPrintTools.isRetentionRuntime("home.work.task7.CamelCase"));
    }
